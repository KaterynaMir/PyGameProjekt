...
class GameState:
    ...
    def draw_horizontally_centered_text(self, surface, rendered_text, y):
...
class GameOver(GameState):
    ...
    def __init__(self):
        ...
        self.menu_button = button.Button("MAIN MENU",self.font2,self.BUTTON_COLOUR,self.HOVERED_COLOUR,(400,250),300,75,20)
        self.quit_button = button.Button("QUIT GAME",self.font2,self.BUTTON_COLOUR,self.HOVERED_COLOUR,(400,370),300,75,20)
